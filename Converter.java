...
public class Converter {
	...
	public static void binaryToDecimal(String output){
        ...
        try{
        Scanner file = new Scanner(new File(output));
        
        System.out.println("Your decimal value is: " + file.next());
        file.close();
        }catch(IOException e){
        	System.out.println("Error: could not find file or file is blank");
        }
	}
	...
	public static void decimalToBinary(String output){
        ...
        try{
            ...
            System.out.println("Your binary value is: " + file.next());
            file.close();
            }catch(IOException e){
            	System.out.println("Error: could not find file or file is blank");
            }
